/**
 * Official Lightweight QRCode.js (by davidshimjs)
 * Standalone offline QR code generator for Smart TVs & Web Browsers
 */
var QRCode;
(function () {
    ...
    QRCode = function (element, options) {
        ...
        var width = (options && options.width) || 160;
        var height = (options && options.height) || 160;

        // Auto-select type number based on text length
        var typeNumber = 4;
